...
class TestVTTEntry:
    ...
    def test_vtt_entry_with_empty_text(self):
        ...
        entry = VTTEntry(
            cue_id="empty-1", start_time=0.0, end_time=1.0, speaker="Speaker", text=""
        )
...
class TestVTTChunk:
    ...
    def test_vtt_chunk_creation(self, sample_vtt_entries):
        ...
        chunk = VTTChunk(chunk_id=0, entries=sample_vtt_entries, token_count=150)
    ...
    def test_vtt_chunk_empty_entries(self):
        ...
        chunk = VTTChunk(chunk_id=1, entries=[], token_count=0)
    ...
    def test_vtt_chunk_single_entry(self, sample_vtt_entry):
        ...
        chunk = VTTChunk(chunk_id=2, entries=[sample_vtt_entry], token_count=25)

        expected_text = (
            "John Smith: Um, so welcome everyone to, uh, the quarterly meeting."
        )
        assert chunk.to_transcript_text() == expected_text
    ...
    def test_vtt_chunk_multiple_speakers(self):
        ...
        chunk = VTTChunk(chunk_id=3, entries=entries, token_count=50)
    ...
    def test_vtt_chunk_with_filler_words(self):
        ...
        chunk = VTTChunk(chunk_id=4, entries=entries, token_count=30)
    ...
    def test_vtt_chunk_with_newlines_in_text(self):
        ...
        chunk = VTTChunk(chunk_id=5, entries=entries, token_count=20)
    ...
    def test_vtt_chunk_zero_token_count(self, sample_vtt_entries):
        ...
        chunk = VTTChunk(chunk_id=0, entries=sample_vtt_entries, token_count=0)
...
class TestVTTDataIntegrity:
    ...
    def test_empty_and_whitespace_text(self):
        ...
        assert (
            non_empty_lines[2] == "Speaker3: \t"
        )  # Note: split preserves some whitespace
