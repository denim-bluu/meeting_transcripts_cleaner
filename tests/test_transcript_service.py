...
<v Speaker2>How are you?</v>"""
    ...
    async def test_clean_transcript_basic(self):
        ...
        # Mock the AI agents
        with patch.object(service.cleaner, 'clean_chunk', new_callable=AsyncMock) as mock_clean, \
             patch.object(service.reviewer, 'review_chunk', new_callable=AsyncMock) as mock_review:
            ...
            transcript = {
                ...
                "chunks": [VTTChunk(0, [VTTEntry("1", 0.0, 5.0, "Speaker", "Test")], 10)],
                "speakers": ["Speaker"],
                "duration": 5.0
            }
    ...
    def test_export_txt_format(self):
        ...
        transcript = {
            ...
            "chunks": [VTTChunk(0, [VTTEntry("1", 0.0, 5.0, "Speaker", "Hello world")], 10)],
            "speakers": ["Speaker"],
            "duration": 5.0,
