...
class BackendAPIClient:
    ...
    def __init__(self, base_url: Optional[str] = None):
        ...
        # Note: Don't set global Content-Type header as it interferes with file uploads
        # Content-Type will be set per request as needed
    ...
    def upload_and_process_transcript(self, file_content: bytes, filename: str) -> Tuple[bool, str, str]:
        ...
        try:
            ...
            logger.info("Uploading VTT file", filename=filename, size_bytes=len(file_content))
    ...
    def extract_intelligence(self, transcript_id: str, detail_level: str = "comprehensive") -> Tuple[bool, str, str]:
        ...
        try:
            ...
            logger.info("Starting intelligence extraction", transcript_id=transcript_id, detail_level=detail_level)
            ...
            return True, task_id, f"Intelligence extraction started with {detail_level} detail level"
    ...
    def poll_until_complete(self, task_id: str, progress_callback=None, poll_interval: float = 2.0, timeout: float = 300.0) -> Tuple[bool, Dict[str, Any]]:
